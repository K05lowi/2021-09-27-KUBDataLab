...
venue: "Copenhagen University"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Room U14 – 10.4.469 Universitetsparken 2, 2100 Copenhagen"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
humandate: "Sept 27-28, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Christian Boldsen Knudsen", "Mathias Wagner Barløse ", "Marianne Gauffriau", "Ene Rammer Nielsen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jeannette Ekstrøm", "Erik Engelbrekt Schwagermann", "Lorna Wildgaard" , "Henrik Hornemann", "Richard Dennis"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
to obtain the software and data you will need to follow the lesson.**Need help with installation?** drop by Data Lab, KUB Nord - Natur og Sundhedsvidenskab, Nørre Allé 49, 2200 København N, on the 22 september between 12:30 pm and 2pm.
{% endif %}
